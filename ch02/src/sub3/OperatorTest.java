...
public class OperatorTest {
	...
	public static void main(String[] args) {
		...
		boolean rs1 = var1 > var2;// var1이 var2보다 크다라는 참 거짓을 알아야하기에 boolean사용
		...
		boolean res1 = (var3 > 3) && (var4 > 3); // and는 둘다 참이여야함
		boolean res2 = (var3 > 2) && (var4 > 3); 
		boolean res3 = (var3 > 3) || (var4 > 3); // or는 하나라도 맞아도 됌
		boolean res4 = (var3 > 4) || (var4 > 5); // or는 하나라도 맞으면 true
		boolean res5 = !(var3 > var4); // false를 반전시키면 true
